...
import { ROUTE_HOME, ROUTE_SIGN_UP } from "@/constants/routes";

type BreadcrumbSlotProps = PageProps<"/[locale]/sign-up">;
...
export default async function BreadcrumbSlot({ params }: BreadcrumbSlotProps): Promise<ReactNode> {
  ...
  return (
    <BreadcrumbList>
      ...
      <BreadcrumbSeparator />
      <BreadcrumbItem>
        <BreadcrumbPage>{i18n._(ROUTE_SIGN_UP.TITLE)}</BreadcrumbPage>
      </BreadcrumbItem>
    </BreadcrumbList>
  );
}
